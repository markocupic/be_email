window.addEvent('domready', function() {
       ...
       if (addAddressIconTo) {
              addAddressIconTo.addEvent('click', function(event) {
                     popup('/contao/main.php?do=tl_be_email&mode=addAddresses&dest=to&id=' + objUri.getData('id') + '&pid=' + objUri.getData('pid') + '&rt=' + objUri.getData('rt') + '&ref=' + objUri.getData('ref'));
              });
       }
       if (addAddressIconCc) {
              addAddressIconCc.addEvent('click', function(event) {
                  popup('/contao/main.php?do=tl_be_email&mode=addAddresses&dest=cc&id=' + objUri.getData('id') + '&pid=' + objUri.getData('pid') + '&rt=' + objUri.getData('rt') + '&ref=' + objUri.getData('ref'));
              });
       }
       if (addAddressIconBcc) {
              addAddressIconBcc.addEvent('click', function(event) {
                  popup('/contao/main.php?do=tl_be_email&mode=addAddresses&dest=bcc&id=' + objUri.getData('id') + '&pid=' + objUri.getData('pid') + '&rt=' + objUri.getData('rt') + '&ref=' + objUri.getData('ref'));
              });
       }
});
